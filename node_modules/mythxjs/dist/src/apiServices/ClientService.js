...
var ClientService = /** @class */ (function () {
    function ClientService(ethAddress, password, toolName, environment, accessToken) {
        ...
        if (accessToken) {
            ...
            this.analysesService = new AnalysesService_1.AnalysesService(ClientService.jwtTokens, this.toolName);
        }
    }
    /**
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        this.analysesService = new AnalysesService_1.AnalysesService(ClientService.jwtTokens, this.toolName);
                        return [2 /*return*/, ClientService.jwtTokens];
                }
            });
        });
    };
     ...
     */
    ClientService.prototype.submitSourceCode = function (sourceCode, contractName, propertyChecking) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.analysesService.submitSourceCode(sourceCode, contractName, propertyChecking)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
     ...
     * @return {Promise} Resolves with API response, or throws error
     */
    ClientService.prototype.analyze = function (options, propertyChecking) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.analysesService.analyze(options, propertyChecking)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    ClientService.prototype.getPdf = function (uuid) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.analysesService.getPdf(uuid)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    ClientService.prototype.listGroups = function (queryString) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.analysesService.listGroups(queryString)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    ClientService.prototype.createGroup = function (groupName) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.analysesService.createGroup(groupName)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
     ...
     * @return {Promise} Resolves with API response, or throws error
     */
    ClientService.prototype.groupOperation = function (groupId, operationType) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.analysesService.groupOperation(groupId, operationType)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    ClientService.prototype.getGroupById = function (groupId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.analysesService.getGroupById(groupId)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
